package com.micolor.module.userinterface.F005.action;
...
@Namespace("/jsp/userinterface/vpoinvoiceheader")
public class ActionVPoInvoiceHeader extends BaseActionSupport {
...
//            sendStatusXml = "<?xml version='1.0' encoding='UTF-8'?><response><status>success</status><error><errorMsg></errorMsg><errorCode></errorCode></error></response>";
            // 获取返回状态
            List<InterfaceConfig> interfaceConfigs = interfaceConfigService.findByActionName("ActionVPoInvoiceHeader");
