package com.micolor.module.userinterface.F004.service.impl;
 ...
 * F004 采购收货SERVICE
 */
@Service("vPoReceiptHeaderService")
public class VPoReceiptHeaderServiceImpl implements VPoReceiptHeaderService {
    ...
    public List getList() {
        String Hql = "from VPoReceiptHeader";
        return daoService.find(Hql);
    }

    public void sendVPoReceiptHeader() {
        ...
        // 获取采购收货主数据
        List<VPoReceiptHeader> vPoReceiptHeaders = this.getList();
