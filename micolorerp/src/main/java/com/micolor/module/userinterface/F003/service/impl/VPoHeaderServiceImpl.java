package com.micolor.module.userinterface.F003.service.impl;
 ...
 * F002 供应商主数据SERVICE
 */
@Service("vPoHeaderService")
public class VPoHeaderServiceImpl implements VPoHeaderService {
    ...
    public List getList() {
        String Hql = "from VPoHeader";
        return daoService.find(Hql);
    }

    public void sendVPoHeader() {
        ...
        // 获取采购订单主数据
        List<VPoHeader> vPoHeaders = this.getList();
