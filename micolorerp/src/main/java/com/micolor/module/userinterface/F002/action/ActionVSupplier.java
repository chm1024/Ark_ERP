package com.micolor.module.userinterface.F002.action;
...
@Namespace("/jsp/userinterface/vsupplier")
public class ActionVSupplier extends BaseActionSupport {

    @Resource
    private VSupplierSerivce vSupplierSerivce;
    ...
    public String execute() {
        ...
        // 获取供应商主数据列表
        List<VSupplier> vSuppliers = vSupplierSerivce.getList();
