...
<head>
    ...
    <script src="<%=basePath%>/resources/micolor/userinterface/interfacelogs/senderrlogs.js"></script>
</head>
<body>
<div class="box  box-info">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-table"></i> 接口发送错误日志列表</h3>
    </div><!-- /.box-header -->
    <div class="box-body">
...
<input type="hidden" id="logid" value="<%=request.getParameter("logid")%>">
</body>
